...
echo "<p>" . strtoupper($loremIpsum). "</p>"; //mencetak teks loremIpsum, mengubahnya menjadi huruf kapital
echo "<p>" . strtolower($loremIpsum). "</p>"; //mencetak teks loremIpsum, mengubahnya menjadi huruf kecil
