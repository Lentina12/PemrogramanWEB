...
<body>
    ...
    <form id="myForm"> <!--Form dengan id myForm-->
        <label for="buah">Pilih Buah: </label> <br> <!--Pembuatan Label untuk buah-->
        ...
        <label>Pilih Warna Favorit:</label> <br> <!--Pembuatan Label untuk warna-->
        <!--Tipe Checkbox untuk memilih warna-->
        ...
        <label>Pilih Jenis Kelamin:</label> <br> <!--Pembuatan Label untuk Jenis kelamin-->
        <!--Tipe Radio button untuk memilih jenis kelamin-->
    ...
    <script>
        $(document).ready(function () {
            $("#myForm").submit(function (e) {
                ...
                $.ajax({
                    url: "proses_lanjut.php", // nama file PHP yang sesuai 
                    type: "POST",
                    data: formData,
